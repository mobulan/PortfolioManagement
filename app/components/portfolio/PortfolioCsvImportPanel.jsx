      ...
      <div className="portfolio-form">
        ...
        <div className="portfolio-inline-form">
          <button
            ...
            onClick={() => runAction('analyze', onAnalyze)}
            disabled={!canAnalyze}
          >
          ...
          <button
            type="button"
            className="button secondary"
            onClick={() => runAction('apply', onApply)}
            disabled={!canApply}
          >
            <Upload size={16} />
          ...
          <button
            type="button"
            className="button secondary"
            onClick={() => runAction('export', onExport)}
            disabled={!canExport}
          >
            <Download size={16} />
        ...
        {result?.actionCounts && (
          <div className="portfolio-import-action-summary">
            {Object.entries(result.actionCounts).map(([action, count]) => (
              <span key={action}>
